        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select id="suffix" name="suffix">
                    ...
                    <option value="4">ตรวจสุขภาพ</option>
                    <option value="5">เฉพาะทาง</option>
                    <option value="6">เด็ก</option>
        ...
        <div class='box-content'>
            ...
            <div>
                ...
                <select id="select_department">
                    ...
                    <option value="Chronic">เฉพาะทาง</option>
                ...
                <div style="float:right">
                    <form method="get" style="display: inline-block;">
                        <input type="hidden" name="page" value="user/clear">
...
$(function(){
    ...
    function clickCall(e){
        ...
        $.post('index.php?page=user/set_call', {vn_id: vn_id, room_path: room_path,suffix_path: suffix_path, room_name: room_name}, function(data){}, 'json');
    }
